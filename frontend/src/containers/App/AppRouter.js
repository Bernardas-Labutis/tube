		...
		return (
			<Switch>
				...
				<Route
					...
					path={`${url}/googlemap`}
					component={asyncComponent(() =>
						import("../Map/GoogleMap/googleMap")
					)}
				/>
				<Route
					exact
